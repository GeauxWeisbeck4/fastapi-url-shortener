...
```
cd existing_repo
git remote add origin https://gitlab.com/GeauxWeisbeck4/url-shortener-fastapi.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/GeauxWeisbeck4/url-shortener-fastapi/-/settings/integrations)
